...
extern "C" {
// Initialization.
GDExtensionBool GDE_EXPORT rocket_boost_init(GDExtensionInterfaceGetProcAddress p_get_proc_address, const GDExtensionClassLibraryPtr p_library, GDExtensionInitialization *r_initialization) {
